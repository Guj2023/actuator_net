...
from PyQt5.QtWidgets import QFileDialog, QMainWindow, QTextBrowser
...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.btn_chooseFile.setGeometry(
            btn_base_width, btn_base_height, btn_box_width, btn_box_height
        )
        ...
        self.btn_displayData.setGeometry(
            btn_base_width + 220, btn_base_height, btn_box_width, btn_box_height
        )
        ...
        label.setGeometry(
            btn_base_width, btn_base_height * 2, btn_box_width, btn_box_height
        )
        self.lineEdit = QLineEdit(str(self.data_start), parent=self)
        self.lineEdit.setGeometry(
            btn_base_width, btn_base_height * 3, btn_box_width, btn_box_height
        )
        ...
        label.setGeometry(
            btn_base_width + 220, btn_base_height * 2, btn_box_width, btn_box_height
        )
        self.lineEdit = QLineEdit(str(self.data_end), parent=self)
        self.lineEdit.setGeometry(
            btn_base_width + 220, btn_base_height * 3, btn_box_width, btn_box_height
        )
        self.lineEdit.setObjectName("lineEdit")
        ...
        label.setGeometry(
            btn_base_width, btn_base_height * 4, btn_box_width, btn_box_height
        )
        self.lineEdit = QLineEdit(str(self.plot_data_len), parent=self)
        self.lineEdit.setGeometry(
            btn_base_width, btn_base_height * 5, btn_box_width, btn_box_height
        )
        self.lineEdit.setObjectName("lineEdit")
        ...
        label.setGeometry(
            btn_base_width + 220, btn_base_height * 4, btn_box_width, btn_box_height
        )
        self.lineEdit = QLineEdit(str(self.plot_data_name), parent=self)
        self.lineEdit.setGeometry(
            btn_base_width + 220, btn_base_height * 5, btn_box_width, btn_box_height
        )
        self.lineEdit.setObjectName("lineEdit")
        ...
        self.plot_btn.setGeometry(
            btn_base_width, btn_base_height * 6, btn_box_width, btn_box_height
        )
        ...
        self.clear_plot_btn.setGeometry(
            btn_base_width + 220, btn_base_height * 6, btn_box_width, btn_box_height
        )
        ...
        label.setGeometry(
            btn_base_width, btn_base_height * 7, btn_box_width, btn_box_height
        )
        self.lineEdit = QLineEdit(str(self.epochs), parent=self)
        self.lineEdit.setGeometry(
            btn_base_width, btn_base_height * 8, btn_box_width, btn_box_height
        )
        self.lineEdit.setObjectName("lineEdit")
        ...
        label.setGeometry(
            btn_base_width + 220, btn_base_height * 7, btn_box_width, btn_box_height
        )
        self.lineEdit = QLineEdit(
            ",".join([str(idx) for idx in self.motors]), parent=self
        )
        self.lineEdit.setGeometry(
            btn_base_width + 220, btn_base_height * 8, btn_box_width, btn_box_height
        )
        self.lineEdit.setObjectName("lineEdit")
        ...
        label.setGeometry(
            btn_base_width, btn_base_height * 9, btn_box_width, btn_box_height
        )
        self.lineEdit = QLineEdit(str(self.sample_freq), parent=self)
        self.lineEdit.setGeometry(
            btn_base_width, btn_base_height * 10, btn_box_width, btn_box_height
        )
        self.lineEdit.setObjectName("lineEdit")
        ...
        label.setGeometry(
            btn_base_width + 220, btn_base_height * 9, btn_box_width, btn_box_height
        )
        self.combobox = QComboBox(parent=self)
        self.combobox.addItems(["False", "True"])
        self.combobox.setGeometry(
            btn_base_width + 220, btn_base_height * 10, btn_box_width, btn_box_height
        )
        ...
        label.setGeometry(
            btn_base_width, btn_base_height * 11, btn_box_width, btn_box_height
        )
        self.modelInputLineEdit = QLineEdit(",".join(self.model_input), parent=self)
        self.modelInputLineEdit.setGeometry(
            btn_base_width, btn_base_height * 12, btn_box_width, btn_box_height
        )
        ...
        label.setGeometry(
            btn_base_width + 220, btn_base_height * 11, btn_box_width, btn_box_height
        )
        self.modelOutputLineEdit = QLineEdit(",".join(self.model_output), parent=self)
        self.modelOutputLineEdit.setGeometry(
            btn_base_width + 220, btn_base_height * 12, btn_box_width, btn_box_height
        )
        ...
        self.btn_trainModel.setGeometry(
            btn_base_width, btn_base_height * 13, btn_box_width, btn_box_height
        )
        ...
        self.btn_showResult.setGeometry(
            btn_base_width + 220, btn_base_height * 13, btn_box_width, btn_box_height
        )
    ...
    def slot_btn_chooseFile(self):
        self.dataFileName, self.fileType = QFileDialog.getOpenFileName(
            self, "选取文件", self.cwd, "Data Files (*.csv)"  # 起始路径
        )  # 设置文件扩展名过滤,用双分号间隔
    ...
    def slot_plot_data(self):
        ...
        y = self.dp_worker.pd_data.loc[
            self.data_start : self.data_start + self.plot_data_len, self.plot_data_name
        ].values
